	...
	<body class="login">
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2>HNO | Registro de Recepcionistas</h2></a>
				</div>
				...
				<div class="box-register">
					<form name="registration" id="registration"  method="post" onSubmit="return valid();">
						<fieldset>
							...
							<div class="form-group">
								<input type="text" class="form-control" name="city" placeholder="Zona" required>
							</div>
							<div class="form-group">
								<label class="block">
									Genero
							...
							<div class="form-group">
								<span class="input-icon">
									<input type="email" class="form-control" name="email" id="email" onBlur="userAvailability()"  placeholder="Correo Electronico" required>
